...
### 介绍
#### 使用 npm 来管理应用程序依赖包；
&emsp;&emsp;npm 官网地址：[npmjs.com](https://www.npmjs.com/)；
&emsp;&emsp;npm 全称 Node Package Manager 是 node 应用程序依赖包的管理工具，包括安装、卸载、更新模块操作；
&emsp;&emsp;使用 nodejs 开发时一般使用 npm 来管理 nodejs 中的包。
